...
node {
  ...
  stage('6 Deploy- tomcat') {
       ...
       deploy adapters: [tomcat9(credentialsId: '93782ba8-087a-44fc-8965-a08ee5647470', path: '', url: 'http://3.239.198.189:8080/')], contextPath: '/scripted', onFailure: false, war: 'target/*war'
  }
}
